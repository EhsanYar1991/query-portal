...
/**
 * Registration and Login form for Swagger UI.
 * Adding the custom registration and login for into swagger API listening.
 * */
public class RegistrationAndLoginFormOperations extends ApiListingScanner {
    ...
    public RegistrationAndLoginFormOperations(ApiDescriptionReader apiDescriptionReader, ApiModelReader apiModelReader,
